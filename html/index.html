...
<html>
	...
	<body>
		...
		<div class="container">
			...
			<!--Title-->
			<h1><a href="”#”">Welcome To FeedMe!</a></h1>
				...
				<div class="span8">
					...
					<div>
						...
						<form>
							...
							<input type="checkbox" name="eula" /> I agree to the 
							<a href="term.html" target="_blank">Terms of Service</a>
							<br/><br/>
			...
			<div class="hero-unit">
				...
				<a href="#" class="btn btn-large btn-success">Start Feeding</a>
			</div>
